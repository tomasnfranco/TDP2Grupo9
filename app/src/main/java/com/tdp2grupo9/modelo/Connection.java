...
public abstract class Connection {
    ...
    public static final String ROMIAPK = "192.168.0.14";
    public static final String EMMAAPK = "192.168.1.13";

    private static final String SERVERURL = "http://"+EMMAAPK+":8080/api/"; //TODO: pasar a un .config o algo
